...
# 1 "cudaTensorCoreGemm.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T45) {  __nv_dummy_param_ref(__T45); __nv_save_fatbinhandle_for_managed_rt(__T45); __cudaRegisterEntry(__T45, ((void ( *)(half *, float *, int))convertFp32ToFp16), _Z17convertFp32ToFp16P6__halfPfi, (-1)); __cudaRegisterEntry(__T45, ((void ( *)(half *, half *, float *, int, int, int, float, float))wmma_example), _Z12wmma_exampleP6__halfS0_Pfiiiff, (-1)); }
